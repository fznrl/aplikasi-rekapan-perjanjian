 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-light-lightblue-primary elevation-4">
    ...
    <a href="{{route('dashboard')}}" class="brand-link">
      <img src="assets/dist/img/pelindo.png" alt="pelindo" class="brand-image img-circle">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 ">
        <div class="image">
          <img src="assets/dist/img/pelindo.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
